...
class MidiPlayer:
    def __init__(self, app):
        ...
        self.note_display = tk.Label(app.root, text="")  # Etichetta per la visualizzazione delle note
            ...
            with mido.MidiFile(self.file_path) as midi_file:
                ...
                for msg in midi_file.play():
                    ...
                    if msg.type == "control_change":
                        ...
                        msg_with_volume.control = 7  # Numero di controllo del volume MIDI
...
class MidiPlayerApp:
    def __init__(self, root):
        ...
        self.open_button = tk.Button(root, text="Apri MIDI File", command=self.player.open_file)
